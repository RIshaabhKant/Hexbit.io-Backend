...
class UserProfile(AbstractBaseUser, PermissionsMixin):
    ...
    account_number = models.CharField('account_number',max_length=17, blank=True)
    ...
    REQUIRED_FIELDS = ['name', 'country', 'mobile', 'pan_number', 'legal_entity_name', 'incorporation_type', 'fssai_number', 'gst_number', 'bank_account', 'account_number', 'ifsc_code']
